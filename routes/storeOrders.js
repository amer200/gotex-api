...
router.get('/:orderId', userMiddlewares.isAuth, orderController.getOrderById);  // Get a single order by ID
router.put('/:orderId', adminMiddleware.isAuth, orderController.updateOrderStatus); // Update order status by ID
