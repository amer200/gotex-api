...
routes.post("/create-user-order", userMiddlewares.isAuth, userMiddlewares.isVerfied, smsaMiddleware.isCrProofed, smsaMiddleware.smsaCheck, smsaControllers.createUserOrder);
