...
routes.post("/create-user-order", userMiddlewares.isAuth, smsaMiddleware.isCrProofed, userMiddlewares.isVerfied, smsaMiddleware.smsaCheck, smsaControllers.createUserOrder);
